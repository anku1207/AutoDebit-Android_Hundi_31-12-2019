...
public class Revoke_ListViewItemCheckbox extends BaseAdapter implements CompoundButton.OnCheckedChangeListener{
    ...
    public Revoke_ListViewItemCheckbox(Context context, List<ServiceTypeVO> dataList, int design) {
