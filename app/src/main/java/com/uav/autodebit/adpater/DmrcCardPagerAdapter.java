...
public class DmrcCardPagerAdapter extends PagerAdapter {

    private Context context;
    private List<DMRC_Customer_CardVO> banners;


    public DmrcCardPagerAdapter(Context context, List<DMRC_Customer_CardVO> banners ){
    ...
    public Object instantiateItem(ViewGroup container, int position) {
        ...
        DMRC_Customer_CardVO dmrc_customer_cardVO = banners.get(position);
        ...
        Picasso.with(context)
                .load(dmrc_customer_cardVO.getImage())
